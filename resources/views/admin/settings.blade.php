  ...
  <main class="settings-page">
    <div class="settings-page__container">
      ...
      <div class="settings-grid">
        <a class="settings-card" href="{{ route('admin.change-username') }}">
        ...
        <a class="settings-card" href="{{ route('admin.change-password') }}">
          <div class="settings-card__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        ...
        <a class="settings-card settings-card--danger" href="{{ route('admin.delete-account') }}">
          <div class="settings-card__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
              <path d="M3 6h18" />
              <path d="M8 6V4h8v2" />
