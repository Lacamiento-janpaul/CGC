...
@section('content')
  ...
  <main class="profile-page" id="profile-page">
    <div style="padding: 1.5rem max(1rem, env(safe-area-inset-right)) 0 max(1rem, env(safe-area-inset-left));display:flex;gap:1rem;align-items:center;">
      <a href="{{ route('user.dashboard') }}" class="dashboard-btn" style="margin:0;">← Back to dashboard</a>
      @if($successMessage)
        <p style="margin:0;padding:0.5rem 1rem;background:rgba(76,175,80,0.15);border:1px solid rgba(76,175,80,0.35);border-radius:8px;color:#2e7d32;font-size:0.9rem;">✓ {{ $successMessage }}</p>
      @endif
    </div>
      ...
      <div class="profile-page__container">
        <section class="profile-overview-card" aria-labelledby="profile-heading">
          ...
          <div class="profile-upload">
            <h2 id="upload-photo-heading" class="profile-card__title">{{ auth()->user()->name ?? auth()->user()->username }}</h2>
              ...
              <li class="profile-list__item">
                ...
                <span class="profile-list__value">
                  <input
                    ...
                    type="text"
                    name="sex"
                    value="{{ old('sex', auth()->user()->profile['sex'] ?? '') }}"
                    style="width:100%; border:none; background:transparent; outline:none;"
                  />
                </span>
              </li>
              ...
              <li class="profile-list__item">
                ...
                <span class="profile-list__value">
                  <input
                    ...
                    type="text"
                    name="nationality"
                    value="{{ old('nationality', auth()->user()->profile['nationality'] ?? '') }}"
                    style="width:100%; border:none; background:transparent; outline:none;"
                  />
                </span>
              </li>
              <li class="profile-list__item">
                ...
                <span class="profile-list__value">
                  <input
                    ...
                    value="{{ old('residential_address', auth()->user()->profile['residential_address'] ?? '') }}"
                    style="width:100%; border:none; background:transparent; outline:none;"
                  />
                </span>
              </li>
              <li class="profile-list__item">
                ...
                <span class="profile-list__value">
                  <input
                    ...
                    value="{{ old('business_address', auth()->user()->profile['business_address'] ?? '') }}"
                    style="width:100%; border:none; background:transparent; outline:none;"
                  />
                </span>
              </li>
              <li class="profile-list__item">
                ...
                <span class="profile-list__value">
                  <input
                    ...
                    type="text"
                    name="contact_number"
                    value="{{ old('contact_number', auth()->user()->profile['contact_number'] ?? '') }}"
                    style="width:100%; border:none; background:transparent; outline:none;"
                  />
                </span>
              </li>
                ...
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="vessel_name"
                      value="{{ old('vessel_name', auth()->user()->profile['vessel_name'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      value="{{ old('security_number', auth()->user()->profile['security_number'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      class="profile-input"
                      type="text"
                      name="former_name_registry"
                      value="{{ old('former_name_registry', auth()->user()->profile['former_name_registry'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="home_port"
                      value="{{ old('home_port', auth()->user()->profile['home_port'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      class="profile-input"
                      type="text"
                      name="certificate_issuance_date"
                      value="{{ old('certificate_issuance_date', auth()->user()->profile['certificate_issuance_date'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      value="{{ old('certificate_expiration', auth()->user()->profile['certificate_expiration'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="material_hull"
                      value="{{ old('material_hull', auth()->user()->profile['material_hull'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                ...
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="length_meters"
                      value="{{ old('length_meters', auth()->user()->profile['length_meters'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="breadth_meters"
                      value="{{ old('breadth_meters', auth()->user()->profile['breadth_meters'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="depth_meters"
                      value="{{ old('depth_meters', auth()->user()->profile['depth_meters'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="gross_tonnage"
                      value="{{ old('gross_tonnage', auth()->user()->profile['gross_tonnage'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="net_tonnage"
                      value="{{ old('net_tonnage', auth()->user()->profile['net_tonnage'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="dead_weight"
                      value="{{ old('dead_weight', auth()->user()->profile['dead_weight'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="engine_make"
                      value="{{ old('engine_make', auth()->user()->profile['engine_make'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="serial_number"
                      value="{{ old('serial_number', auth()->user()->profile['serial_number'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="horse_power"
                      value="{{ old('horse_power', auth()->user()->profile['horse_power'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
                <li class="profile-list__item">
                  ...
                  <span class="profile-list__value">
                    <input
                      ...
                      type="text"
                      name="speed"
                      value="{{ old('speed', auth()->user()->profile['speed'] ?? '') }}"
                      style="width:100%; border:none; background:transparent; outline:none;"
                    />
                  </span>
                </li>
        ...
        <div class="profile-card__actions" style="margin-top: 2rem;">
          <button type="submit" class="btn-login" style="padding:0.9rem 2.2rem;font-weight:600;letter-spacing:0.05em;">Save All Changes</button>
        </div>
      </div>
    </form>
  </main>
