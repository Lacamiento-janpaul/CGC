...
<head>
  ...
  <title>@yield('title', 'User — Aparri Philippine Coast Guard')</title>
...
<body>
  <header class="site-header">
    ...
    <div class="admin-user-menu">
      ...
      <nav class="admin-user-dropdown" aria-label="User menu">
        <ul class="admin-menu-items">
          <li>
            <a href="{{ route('user.dashboard') }}" class="admin-menu-link">
          ...
          <li>
            <a href="{{ route('user.profile') }}" class="admin-menu-link">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
          ...
          <li>
            <a href="{{ route('user.settings') }}" class="admin-menu-link">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
